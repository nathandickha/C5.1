...
/* =====================================================
    ...
    if (stepCount > 0) {
      ...
      for (let s = 0; s < stepCount; s++) {
        ...
        const isDiagonalNarrow = liveParams?.stepShape === "diagonal" && s !== 1 && layout.position !== "center";
      ...
      step.userData.stepShape = this.params?.stepShape === "diagonal" ? "diagonal" : "rectangle";
